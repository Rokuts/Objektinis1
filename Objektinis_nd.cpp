...
int main()
{
    ...
    if(t == 0) 
        cout << left << setw(dydis[y - 1] + 3) << "Pavarde" << setw(dydis[y - 1] + 3) << "Vardas" << setw(dydis[y - 1] + 3) << "Galutinis (Vid.)" << endl;
    else 
    ...
    for(int i = 0; i < y; i++){
        if(t == 0) 
            cout << left << setw(dydis[y - 1] + 3) << S[i].pavarde << setw(dydis[y - 1] + 3) << S[i].vardas << setw(dydis[y - 1] + 3) << S[i].galutinisVid << endl;
        else 
            cout << left << setw(dydis[y - 1] + 3) << S[i].pavarde << setw(dydis[y - 1] + 3) << S[i].vardas << setw(dydis[y - 1] + 3) << S[i].galutinisMed << endl;
    }
